...
if __name__ == '__main__':
    ...
    pinhole_path = Path("D://pinhole_projection")
    ...
    volume = o3d_integration.ScalableTSDFVolume(
        ...
        #color_type=o3d_integration.TSDFVolumeColorType.NoColor)
    ...
    with open(str(rgb_file_list)) as rf, open(str(depth_file_list)) as df:
        ...
        while True:
            ...
            if not rgb_line or not depth_line:
                break
            rgb_path = str(pinhole_path / 'rgb' / rgb_line.split()[0])
            depth_path = str(pinhole_path / 'depth' / depth_line.split()[0])
            print(rgb_path)
    ...
    pcd_path = str(pinhole_path / 'tsdf-pc.pcd')
